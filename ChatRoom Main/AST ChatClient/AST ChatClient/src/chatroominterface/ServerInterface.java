...
public interface ServerInterface extends Remote{
	...
	public boolean logout( ClientInterface clientInterface) throws RemoteException;	//Use to login to the chatroom.
	public void publish( String message) throws RemoteException; 	 //Send messages to clients and to server.
	public Vector<ClientInterface> getConnectedClients() throws RemoteException;	 //Get all clients connected to the chatroom.
